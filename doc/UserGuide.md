...
> 
> Addresses must be formatted as a/BLOCK, STREET, UNIT, POSTAL_CODE
>
> Put a `p` before the phone / email / address prefixes to mark it as `prate`. `private` details can only
...
* `add Betsy Crowe pp/1234567 e/betsycrowe@gmail.com pa/Block 456, Newgate Prison, #9, 98765 t/criminal t/friend`
